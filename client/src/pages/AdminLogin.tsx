    ...
    <div style={{ minHeight:'100vh', display:'flex', fontFamily:"'DM Sans',system-ui,sans-serif" }}>
      ...
      <div style={{ width:'42%', background:'#1A2E0A', display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', padding:'48px 40px', position:'relative', overflow:'hidden' }}
        ...
        <div style={{ position:'relative', zIndex:1, textAlign:'center', color:'#F7F4EE' }}>
          <div style={{ width:72, height:72, borderRadius:'50%', background:'linear-gradient(135deg,#2D5016,#4A7C28)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:32, margin:'0 auto 24px', boxShadow:'0 8px 32px rgba(45,80,22,.5)' }>
          ...
          <h1 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif", fontSize:32, fontWeight:700, lineHeight:1.15, marginBottom:12 }}>
            Admin<br/><em style={{ fontStyle:'italic', color:'#A8D878' }}>Portal</em>
          </h1>
          ...
          {[
            ...
            <div key={String(label)} style={{ display:'flex', alignItems:'center', gap:12, marginBottom:14, textAlign:'left' }}>
              <div style={{ width:36, height:36, borderRadius:10, background:'rgba(168,216,120,.1)', border:'1px solid rgba(168,216,120,.15)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:15, flexShrink:0 }}>{icon}</div>
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', background:'#fff', padding:'40px 24px' }}>
        <div style={{ width:'100%', maxWidth:400 }}>
          <div className="flex lg:hidden" style={{ justifyContent:'center', marginBottom:28 }}>
            <div style={{ width:52, height:52, borderRadius:'50%', background:'linear-gradient(135deg,#2D5016,#4A7C28)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:24 }>
              {schoolLogo ? <img src={schoolLogo} alt={schoolName} style={{ width:'100%', height:'100%', objectFit:'cover', borderRadius:'50%' }} /> : '⭐'}
            </div>
          </div>
          ...
          <div style={{ marginBottom:32 }}>
            ...
            <h2 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif", fontSize:34, fontWeight:700, color:'#1A2E0A', lineHeight:1.1, marginBottom:6 }}>Admin Sign In</h2>
            <p style={{ fontSize:14, color:'#718096' }}>Enter your admin email and password</p>
          </div>

          <form onSubmit={handleSubmit} style={{ display:'flex', flexDirection:'column', gap:20 }}>
            <div>
              <Label htmlFor="email" style={{ display:'block', fontSize:13, fontWeight:600, color:'#2D3748', marginBottom:6 }}>Email Address</Label>
              <Input
                id="email"
                type="email"
            ...
            <div>
              <Label htmlFor="password" style={{ display:'block', fontSize:13, fontWeight:600, color:'#2D3748', marginBottom:6 }}>Password</Label>
          ...
          <div style={{ marginTop:24, textAlign:'center' }}>
            <button onClick={() => setLocation('/')} style={{ fontSize:13, color:'#718096', background:'none', border:'none', cursor:'pointer' }}>
